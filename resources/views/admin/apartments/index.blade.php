...
<div class="d-flex justify-content-between align-items-center my-3">
    ...
    <a class="btn btn-primary" role="button" href="{{ route('admin.apartments.create') }}"><i class="fas fa-plus createcircle"></i> Nuovo appartamento</a>
</div>
...
<div class="d-flex flex-wrap justify-content-center">
    ...
    <div class="card m-3 shadow" style="width: 350px;">
        <img height="230" width="100%" src="{{ asset('storage/' . $apartment->image) }}" class="card-img-top" alt="{{ $apartment->name }}">
        <div class="card-body">
        ...
        <ul class="list-group list-group-flush">
            ...
            <li class="list-group-item"><a name="" id="" class="btn btn-light btn-block" href="{{ route('admin.stats', $apartment->id) }}" role="button"><i class="fas fa-chart-line mr-3"></i> Statistiche
                    appartamento</a></li>
            <li class="list-group-item"><a name="" id="" class="btn btn-success btn-block" href="{{ route('admin.buySponsorship', $apartment->id) }}" role="button"><i class="fas fa-bullhorn mr-3"></i> Promuovi appartamento</a></li>
        </ul>
        <div class="card-body d-flex justify-content-between align-items-center flex-wrap">
            ...
            <a href="{{ route('admin.apartments.edit', $apartment->id) }}" class="btn btn-sm btn-secondary mx-3">
                <i class="fas fa-pencil-alt fa-sm fa-fw"></i> Modifica
            </a>

            <!-- Button trigger modal -->
            <button type="button" class="btn btn-sm btn-danger" data-toggle="modal" data-target="#apartment-{{ $apartment->id }}">
