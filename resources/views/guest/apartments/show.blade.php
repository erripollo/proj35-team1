            ...
            <div class="row">
                ...
                <div class="mt-5 col-6">
                    <div class="d-flex flex-column mt-4 divmap">
                            <div class="divbutton"><button class="buttonmap" v-on:click="showMap({{ $apartment->latitude }}, {{ $apartment->longitude }})">MOSTRA MAPPA <i class="fas fa-map-marker-alt"></i></button></div>
