                ...
                <div class="col-12">
                    ...
                    <form action="{{ route('send.message', $apartment->id) }}" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="name" id="name" aria-describedby="nameHelper" placeholder="Add your name">
                            <small id="nameHelper" class="form-text text-muted">Type your name</small>
                        </div>
                        <div class="form-group">
                            <label for="lastname">Lastname</label>
                            <input type="text" class="form-control" name="lastname" id="lastname" aria-describedby="lastnameHelper" placeholder="Add your lastname">
                            <small id="lastnameHelper" class="form-text text-muted">Type your lastname</small>
                        </div>
                        <div class="form-group">
                            <label for="email">Email address</label>
                            <input type="email" class="form-control" name="email" id="email" aria-describedby="emailHelper" placeholder="Add your email address" value="{{ $user }}">
