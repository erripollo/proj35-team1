        ...
        <form action="{{ route('house') }}" method="get">
            ...
            <div class="d-flex align-items-start">
                <div class="form-group">
                    <div>
                        <input type="text" v-on:keyup="autocompleteAddress" v-model="location" class="form-control mr-2" name="location" id="location" aria-describedby="helpId" placeholder="Search City" style="width: 300px">
                        ...
                        <div class="list-group">
                            <a v-for="item in autocomplete" @click="searchHomePage(item)" href="#" class="list-group-item list-group-item-action">@{{ item . address . municipality }},
